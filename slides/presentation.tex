...
\begin{frame}{Individual contribution}
    \begin{itemize}
        \item Single-author project: preprocessing, augmentations, model code, training pipeline, Colab workflow
        \item Result analysis, report, and slides
        \item Development: Codex $\rightarrow$ Cursor; Stages~B \&~C on Colab (NVIDIA GPU)
    \end{itemize}
\end{frame}
